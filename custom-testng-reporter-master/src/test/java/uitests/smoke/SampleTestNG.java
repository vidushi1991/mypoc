 ...
 *
 */
public class SampleTestNG extends BaseUtilTest{
	 ...
	 private WebElement element;
	    ...
	    {
	        element = new WebDriverWait(driver, 50).until(ExpectedConditions.visibilityOfElementLocated(By.name("q")));
